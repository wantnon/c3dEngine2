...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	for (UITouch *touch in touches) {
        ...
        Ctouch gaTouch=Ctouch(touchPoint.x,touchPoint.y,e_touchBegan,Cc3dFrameCounter::sharedFrameCounter()->getCount());
        CtouchSequence::sharedTouchSequence()->addTouch(gaTouch);
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	for (UITouch *touch in touches) {
		CGPoint touchPoint=[touch locationInView:self.view] ;
        Ctouch gaTouch=Ctouch(touchPoint.x,touchPoint.y,e_touchMove,Cc3dFrameCounter::sharedFrameCounter()->getCount());
        CtouchSequence::sharedTouchSequence()->addTouch(gaTouch);
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	for (UITouch *touch in touches) {
		CGPoint touchPoint=[touch locationInView:self.view] ;
        Ctouch gaTouch=Ctouch(touchPoint.x,touchPoint.y,e_touchEnd,Cc3dFrameCounter::sharedFrameCounter()->getCount());
        CtouchSequence::sharedTouchSequence()->addTouch(gaTouch);
